...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/josh/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/josh/.local/share/qutebrowser/userscripts/*')
...
# Type: QssColor
c.colors.statusbar.command.fg = '#0087FF'
...
c.colors.tabs.even.bg = "#6000ff00"
c.colors.tabs.odd.bg = "#FF006000"
c.colors.tabs.bar.bg = "#FFcccc"
...
c.url.searchengines = {
        ...
        '!wf': 'https://wiki.warframe.com/?title=Special:Search&fulltext=1&search={}'
        }
